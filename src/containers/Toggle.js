...
const Toggle = () => {
  ...
  return(
    <div className="row">
      <button onClick={() => SetSelected(0)} className={`col-3 ${style[0]}`}>
        <div className="pr-3 pl-3">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              viewBox="0 0 100 70" enableBackground='new 0 0 100 70'>
            <g id="out_1_">
      ...
      <button onClick={() => SetSelected(1)} className={`col-3 ${style[1]}`}>
      ...
      <button onClick={() => SetSelected(2)} className={`col-3 ${style[2]}`}>
        <div className="pr-3 pl-3">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 100 70" enableBackground='new 0 0 100 70'>
      ...
      <button onClick={() => SetSelected(3)} className={`col-3 ${style[3]}`}>
        <div className="pr-4 pl-4">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              viewBox="0 0 100 70" enableBackground='new 0 0 100 100;' >
            <circle className="st0" cx="20" cy="34.84" r="10"/>
            <circle className="st0" cx="53" cy="34.84" r="10"/>
            <circle className="st0" cx="88" cy="34.84" r="10"/>
          </svg>
        </div>
        <p>More</p>
      </button>
